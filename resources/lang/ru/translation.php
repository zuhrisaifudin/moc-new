...
return [
    ...
    "todo" => "Делать",
    "todolists" => "Списки дел",
    "bootstrap-ui-1" => "Начальный пользовательский интерфейс 1",
    "bootstrap-ui-2" => "Начальный пользовательский интерфейс 2",
    "tabler" => "Cтол",
    "tabler-icons" => "Cтол Иконки",
    "list-view"=>"Посмотреть список",
    "grid-view" => "Вид сетки",
    "category" => "Категория",
    "links" => "Ссылки",
    "colored-links" => "Цветные ссылки",
    "overview" => "Обзор",
    ...
    "advanced"=>"Передовой",
    "form-advanced" => "Расширенная форма",
    ...
    "vector"=>"Вектор",
    "leaflet"=>"Листовка",
    "google-map" => "Карты Гугл",
    "vector-map" => "Векторные карты",
    "leaflet-map" => "Листовки Карты",
