...
return [
    ...
    "orders"=>"Pedidos",
    "order-track" => "Seguimiento de pedidos",
    ...
    "category" => "Categoría",
    "links" => "Enlaces",
    "colored-links" => "Enlaces de colores",
    "overview" => "Descripción general",
    ...
    "todo" => "Hacer",
    "todolists" => "Listas de tareas pendientes",
    "bootstrap-ui-1" => "Interfaz de usuario de Bootstrap 1",
    "bootstrap-ui-2" => "Interfaz de usuario de Bootstrap 2",
    "tabler" => "Mesa",
    "tabler-icons" => "Mesa iconos",
    "list-view"=>"Vista de la lista",
    ...
    "vector-map" => "Mapas vectoriales",
    "leaflet-map" => "Mapas de folletos",
