...
return [
    ...
    "orders"=>"Ordini",
    "order-track" => "Traccia dell'ordine",
    ...
    "todo" => "Fare",
    "todolists" => "Elenchi di cose da fare",
    "bootstrap-ui-1" => "Interfaccia utente Bootstrap 1",
    "bootstrap-ui-2" => "Interfaccia utente Bootstrap 2",
    "tabler" => "Tavolo",
    "tabler-icons" => "Tavolo icone",
    ...
    "category" => "Categoria",
    "links" => "Collegamenti",
    "colored-links" => "Collegamenti colorati",
    "overview" => "Panoramica",
    ...
    "vector"=>"Vettore",
    "leaflet"=>"Volantino",
    "google-map" => "Mappe Google",
    "vector-map" => "Mappe vettoriali",
    "leaflet-map" => "Mappe volantino",
