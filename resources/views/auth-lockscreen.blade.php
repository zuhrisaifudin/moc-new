                                ...
                                <div class="card mb-0 border-0 shadow-none mb-0">
                                    <div class="card-body p-sm-5 m-lg-4">
                                        ...
                                        <div class="user-thumb text-center">
                                            <img src="build/images/users/avatar-8.jpg" class="rounded-circle img-thumbnail avatar-lg" alt="thumbnail">
                                            <h6 class="mt-3">Hi ! Richard Marshall</h6>
                                        </div>
                                        <div class="p-2 mt-4">
                                            <form>
                                                <div class="mb-3">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="password" class="form-control password-input" id="userpassword" placeholder="Enter password or pin" required>
                                                    </div>
                                                </div>
                                                <div class="mb-2 mt-4">
                                        ...
                                        <div class="mt-4 text-center">
                                            <p class="mb-1">Not you ? return</p>
                                            <a href="auth-signin" class="fw-semibold text-secondary text-decoration-underline"> Signin </a>
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                            </div>
