...
function isStatus(val) {
    switch (val) {
        case "Pending":
            return ('<span class="badge text-warning bg-warning-subtle text-uppercase">' + val + "</span>");
        case "Inprogress":
            return ('<span class="badge text-secondary bg-secondary-subtle text-uppercase">' + val + "</span>");
        case "Completed":
            return ('<span class="badge text-success bg-success-subtle text-uppercase">' + val + "</span>");
        case "New":
            return ('<span class="badge text-info bg-info-subtle text-uppercase">' + val + "</span>");
    }
}
