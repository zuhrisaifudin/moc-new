...
Array.from(document.querySelectorAll(".toggle-email-panel")).forEach(function (
    item
) {
    item.addEventListener("click", function () {
        if (
...
Array.from(document.querySelectorAll(".mail-user-dropdown")).forEach(function (
    elem
) {
    elem.querySelectorAll(".dropdown-menu .dropdown-item").forEach(function (
        item
    ) {
        item.addEventListener("click", function () {
            elem.querySelector(".mail-profile-img").src =
                item.querySelector(".mail-user-img").src;
        });
    });
});
    ...
    function filterItems(arr, query) {
        return arr.filter(function (el) {
            return (
                ...
                el.description.toLowerCase().indexOf(query.toLowerCase()) !==
                    -1 ||
