    ...
    if (addNewBoard) {
        ...
        function newKanbanbaord() {
            ...
            kanbanlisthtml =
                ...
                '<span class="fw-medium text-muted fs-12">Priority<i class="ti ti-chevron-down ms-1"></i></span>' +
                '</a>' +
                ...
                '</div>' +
                '<div class="my-3">' +
                '<button class="btn btn-subtle-info w-100" data-bs-toggle="modal" data-bs-target="#creatertaskModal">Add More</button>' +
                '</div>' +
                '</div>';
