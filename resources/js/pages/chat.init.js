            ...
            users.forEach(function (userData, index) {
                ...
                <div class="d-flex align-items-center">\
                    ...
                    <div class="flex-grow-1 overflow-hidden">\
                        ...
                        <p class="text-muted fw-light text-truncate small mb-0">' + userData.desc + "</p>\
                    </div>\
                    " + isMessageCount + "\
                </div>\
            </a>\
        ...
        if (msg != null) {
            ...
            <div class="d-flex align-items-center attached-file">\
                <div class="flex-shrink-0 avatar-sm me-3 ms-0 attached-file-avatar">\
                    <div class="avatar-title bg-soft-primary-subtle text-primary rounded-circle font-size-20">\
...
Array.from(document.querySelectorAll(".close-btn-overview")).forEach(function (item) {
    item.addEventListener("click", function () {
        if(bodyElement.classList.contains("chat-detail-show")){
            bodyElement.classList.remove("chat-detail-show");
        }
    });
});
...
function windowResize() {
    ...
    if (windowSize < 1400) {
      document.body.classList.remove("chat-detail-show");
    } else {
      document.body.classList.add("chat-detail-show");
    }
}
